...
const modalDef = toolDefinition({
  name: "get_modal_buttons",
  description:
...
export const getModalButtons = modalDef.server(async () => {
  ...
  if (modals.length === 0) {
    return JSON.stringify({ result: "No modals or popups found on the page.", modals: [] })
  }
